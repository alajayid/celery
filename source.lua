...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			if Main.LocalDepsUpToDate() then
				...
				if localAPI ~= nil then 
					rawAPI = localAPI
				else
					Main.DepsVersionData[1] = ""
				end
			end
			rawAPI = game:HttpGet("https://raw.githubusercontent.com/MaximumADHD/Roblox-Client-Tracker/roblox/Full-API-Dump.json")
		else
	...
	Main.FetchRMD = function()
		...
		return {['Classes'] = classes, ['Enum'] = enums, ['PropertyOrders'] = propertyOrders}
	end
